...
| ----------------- | ------------------------------------------------------------------ | ------------------------------------------- |
| TanStack Start    | [`templates/tanstack-start`](./templates/tanstack-start)            | SSR app with Better Auth + Prisma           |
| Vite SPA + Functions | [`templates/vite-spa-functions`](./templates/vite-spa-functions) | Vite React SPA + Cloudflare Workers backend |
| Vite SPA          | [`templates/vite-spa`](./templates/vite-spa)                       | Vite React SPA - without a backend          |
